...
export interface ApiEncuestaEncuesta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    id_encuesta: Schema.Attribute.UID;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMembresiaMembresia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estado: Schema.Attribute.Enumeration<['activo', 'baja', 'expirado']>;
    fecha_fin: Schema.Attribute.DateTime;
    fecha_inicio: Schema.Attribute.DateTime;
    id_membresia: Schema.Attribute.UID;
    id_pagos: Schema.Attribute.Relation<'oneToMany', 'api::pago.pago'>;
    id_usuarios: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPagoPago extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cant_meses_pago: Schema.Attribute.Enumeration<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    num_personal: Schema.Attribute.Integer;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
